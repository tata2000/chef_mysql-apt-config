...
default['mysql-apt-config']['file_name']['ubuntu']['12'] = 'mysql-apt-config_0.3.2-1ubuntu12.04_all.deb'
default['mysql-apt-config']['md5']['ubuntu']['12'] = '01328fce8160cb8f5d44a2fb3f8e2d56'
default['mysql-apt-config']['file_name']['ubuntu']['14'] = 'mysql-apt-config_0.3.2-1ubuntu14.04_all.deb'
default['mysql-apt-config']['md5']['ubuntu']['14'] = 'f893b0b1495c6c0458c40320c8f556b0'
