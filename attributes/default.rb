...
default['mysql-apt-confing']['file_name']['ubuntu']['14.10'] = 'mysql-apt-config_0.3.2-1ubuntu14.10_all.deb'
default['mysql-apt-confing']['md5']['ubuntu']['14.10'] = 'f684c87394dd1c5aa388378e155adb61'


if node['platform'] == 'ubuntu' and Gem::Version.new(node['platform_version'])>=Gem::Version.new('14.10')
  default['mysql-apt-confing']['download_url'] = node['mysql-apt-confing']['base_url'] + node['mysql-apt-confing']['file_name']['ubuntu']['14.10']
  default['mysql-apt-confing']['download_md5'] = node['mysql-apt-confing']['md5']['ubuntu']['14']
